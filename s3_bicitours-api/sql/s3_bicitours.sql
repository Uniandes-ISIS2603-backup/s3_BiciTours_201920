...
insert into UsuarioEntity (id, nombre, password, correo, pago, esAdmin, deuda) values (1005, 'Jhuliana Barrios', 'code6', 'jj.barriosm@uniandes.edu.co',0,1,1000);
    ...
    values (3000,'El tour de las estrellas', 'Tunja','El Tour más antiguo de GoBici, una leyenda de leyendas apta solo para los más expertos',1,235,500000,0);
    insert into TourEntity (id, nombre, lugar, descripcion, dificultad, duracion, costo, terminado)
    values (3001,'El tour escarabajo', 'Pasto','El Tour ascendente más largo de GoBici, solo para quienes pedalean sin parar por horas',2,300,400000,0);
    insert into TourEntity (id, nombre, lugar, descripcion, dificultad, duracion, costo, terminado)
    values (3002,'El tour oruga', 'Pasto','El Tour para quienes empiezan una nueva vida',0,100,250000,0);
...
/*****************************************************************************************************************************************************************/
    ...
    insert into ComentarioEntity (id, texto, calificacion, tour_id, usuario_id, blog_id) values (5011, 'Esto me alegro el día', 4, 3000, 1001, 4000);
    insert into ComentarioEntity (id, texto, calificacion, tour_id, usuario_id, blog_id) values (5012, 'Nice', 4, 3000, 1001, 4000);
    insert into ComentarioEntity (id, texto, calificacion, tour_id, usuario_id, blog_id) values (5013, 'Best moment ever', 4, 3000, 1001, 4001);
    insert into ComentarioEntity (id, texto, calificacion, tour_id, usuario_id, blog_id) values (5014, 'Casi lloro con esa obra', 4, 3001, 1001, 4001);
    insert into ComentarioEntity (id, texto, calificacion, tour_id, usuario_id, blog_id) values (5015, 'Quien lo diría', 4, 3001, 1001, 4002);
    insert into ComentarioEntity (id, texto, calificacion, tour_id, usuario_id, blog_id) values (5016, 'Nice', 4, 3002, 1001, 4002);
        ...
        insert into ComentarioEntity (id, texto, calificacion, usuario_id, blog_id) values (5001, 'Nada mal', 4, 1002, 4000);

        /**Comentarios asociados a blog id 4001**/
        insert into ComentarioEntity (id, texto, calificacion, usuario_id, blog_id) values (5003, 'Anakin debió darse cuenta en ese momento', 1, 1002, 4001);
        insert into ComentarioEntity (id, texto, calificacion, usuario_id, blog_id) values (5004, 'Best meme ever', 4, 1002, 4001);

        /**Comentarios asociados a blog id 4002**/
        insert into ComentarioEntity (id, texto, calificacion, usuario_id, blog_id) values (5005, 'You almost got me there', 1, 1000, 4002);
        insert into ComentarioEntity (id, texto, calificacion, usuario_id, blog_id) values (5006, 'por favor', 4, 1003, 4002);
