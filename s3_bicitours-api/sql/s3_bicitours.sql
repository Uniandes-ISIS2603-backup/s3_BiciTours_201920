...
insert into SEGUROENTITY (ID,CARACTERISTICAS,CONDICIONES,TIPO) VALUES (1000,'Seguro contra robo de bicicletas','El robo de debe reportar 24 horas despues de sucedido para hacer valido el seguro', 'Antirobo');
insert into SEGUROENTITY (ID,CARACTERISTICAS,CONDICIONES,TIPO) VALUES (1001,'Seguro para fallecimiento','Se hace efectivo si es cliente fallece en un accidente durante el tour', 'Seguro de vida');
insert into SEGUROENTITY (ID,CARACTERISTICAS,CONDICIONES,TIPO) VALUES (1002,'Seguro para lesiones','Se cubren todos los gastos medicos que requiera el participante tras sufrir una lesion en el tour', 'Seguro de salud');
...
insert into TourEntity (id) values (1000);
...
*/'https://www.youtube.com/embed/05dT34hGRdg',1002 );
...
insert into ComentarioEntity (id, texto, calificacion, usuario_id, blog_id) values (1000, 'El mejor monólogo de todos', 1, 1002, 1000);
insert into ComentarioEntity (id, texto, calificacion, tour_id, usuario_id, blog_id) values (1001, 'Nada mal', 4, 1000, 1002, 1000);
insert into ComentarioEntity (id, texto, calificacion, usuario_id, blog_id) values (1002, 'Killer Queen Bites The Dust', 3, 1000, 1000);