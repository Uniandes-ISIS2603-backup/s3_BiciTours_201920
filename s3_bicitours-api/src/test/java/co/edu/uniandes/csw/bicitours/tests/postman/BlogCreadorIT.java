 ...
 */
package co.edu.uniandes.csw.bicitours.tests.postman;

import co.edu.uniandes.csw.bicitours.dtos.BlogDTO;
import co.edu.uniandes.csw.bicitours.mappers.BusinessLogicExceptionMapper;
import co.edu.uniandes.csw.bicitours.resources.BlogResource;
...
public class BlogCreadorIT {

    private static final String COLLECTION = "BlogCreadorResourceTest.postman_collection";
