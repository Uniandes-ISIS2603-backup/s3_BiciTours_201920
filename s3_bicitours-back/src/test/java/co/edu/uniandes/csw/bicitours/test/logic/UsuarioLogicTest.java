...
public class UsuarioLogicTest {
    ...
    /**
     * Prueba que la creación de un usuario con nombre nulo de como resultado
     * una exception
     */
    ...
    /**
     * Prueba que la creación de un usuario con codigo nulo de como resultado
     * una exception
     */
    @Test(expected = BusinessLogicException.class)
    ...
    /**
     * Prueba que la creación de un usuario con correo nulo de como resultado
     * una exception
     */
    @Test(expected = BusinessLogicException.class)
    ...
    /**
     * Prueba que la creación de un usuario con nombre repetido de como
     * resultado una exception
     */
    @Test(expected = BusinessLogicException.class)
    ...
    /**
     * Inserta los datos iniciales para diferentes usuarios, de tal manera que
     * puedan ser testeados todos los métodos
     */
