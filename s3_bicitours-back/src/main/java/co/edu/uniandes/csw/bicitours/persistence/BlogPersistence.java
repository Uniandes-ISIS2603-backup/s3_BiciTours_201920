...
public class BlogPersistence {
    ...
    {
        LOGGER.log(Level.INFO, "Creando nuevo blog");
    ...
    {
        LOGGER.log(Level.INFO, "Consultando el blog con id={0}", blogId);
     ...
     * Actualiza un blog.
     *
     * @param blogEntity: el libro que viene con los nuevos cambios. Por ejemplo
